function run_varspgp_loss_emulator( id, which_data )
...
save_name = sprintf('estimates_loss_emulation_%s_%d', which_data, id);
save( fullfile('Results', 'LossEmulation', 'SigmaInitDefault', save_name), ...
