...
tic
y_train_hat = localgp(x_train, x_train, y_train, gp_options{:});
toc
...
if do_plot
    ...
    for i = 1:25
        subplot(5,5,i)
        scatter(y_train(:,i), y_train_hat(:,i), 15, 'filled')
        axis tight
...
if do_plot
    ...
    for i = 1:25
        clf
        scatter(y_train(:,i), y_train_hat(:,i), 'filled')
        axis tight
...
err = norm( y_train_hat - y_train ).^2;
err
